          ...
          <div className="space-y-8">
            ...
            <Card className="p-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                By accessing and using the ZEVRO website, services, or engaging with our franchise opportunities, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
              </p>
            </Card>
            ...
            <Card className="p-8">
              ...
              <div className="space-y-4">
                <p className="text-gray-700">
                  Permission is granted to temporarily download one copy of the materials on ZEVRO's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
                </p>
                ...
                <p className="text-gray-700">
                  This license shall automatically terminate if you violate any of these restrictions and may be terminated by ZEVRO at any time.
                </p>
              </div>
            </Card>
            ...
            <Card className="p-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-700 mb-4">
                  ZEVRO offers franchise opportunities subject to separate franchise agreements. By expressing interest in our franchise program:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
